...
export default function AppSwipeCard({ src, text, title }) {
    ...
    return (
        ...
        <Flex className="swiper-slide" paddingLeft={["1rem", "1rem", "0", "0"]} flexDir={["column-reverse", "column-reverse", "row", "row"]} marginRight="6rem" marginTop="0.50rem" justifyContent="flex-end" w={["18.75rem", "18.75rem", "67.375rem", "67.375rem"]} >
