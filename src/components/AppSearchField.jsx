        ...
        < InputGroup {...props} size='md' >
            {right ?
                <Flex align="center">
                    ...
                    <Input _placeholder={{ fontWeight: 500, fontSize: "0.9rem", color: colors.linkText }} placeholder={placeholder} backgroundColor="#eef3f8" border="none" h="2.125rem" w="18.125rem" paddingLeft="2.5rem" />
                </Flex>
                :
                <Flex>
