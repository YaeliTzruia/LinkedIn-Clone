    ...
    return (
        <Flex marginBottom="0.5rem" border={`0.5px solid ${colors.border}`} borderRadius="0.5rem" backgroundColor={colors.white} w="20.125rem" h="7.063rem">
            <Flex padding="1rem" w="100%" flexDir="column">
                <AppTextIcon marginX="0.5rem" textColor={colors.mediumGray} fontSize="1rem" padding="0" justifyContent="space-between" reverse text="Edit public profile & URL" src={questionMark} />
                <Flex justifyContent="center" w="100%" align="center">
                    <Divider w="80%" marginY="1rem" />
                </Flex>
                <AppTextIcon marginX="0.5rem" textColor={colors.mediumGray} fontSize="1rem" padding="0" justifyContent="space-between" reverse text="Add profile in another language" src={questionMark} />
