...
export default function ConectLearn() {
    ...
    return (
        <Flex paddingX={["2rem", "1rem", "0", "0"]} justifyContent="center" alignItems="center" paddingY={["3.5rem", "3.5rem", "3.75rem", "3.75rem"]} w="100%">
            <Flex justifyContent="center" alignItems="center" paddingX={["0", "1rem", "0", "0"]} w="100%" flexDir={["column", "column", "row", "row"]} paddingY={["3.5rem", "3.5rem", "7.5rem", "7.5rem"]} >
                <Flex paddingX={["1rem", "0", "0", "0"]} marginRight="1rem" justifyContent="space-between" w={["20.5rem", "21.875rem", "34.75rem", "34.75rem"]} h={["26.75rem", "26.75rem", "34rem", "34rem"]} flexDir="column">
                    <Image
                        w={["15rem", "15rem", "19.5rem", "19.5rem"]} h={["15rem", "15rem", "19.5rem", "19.5rem"]} alt="friends talking" src={img1}
                    />
                    <Heading
                        lineHeight="1.25" fontSize={["2rem", "2rem", "3rem", "3rem"]} fontWeight={[400, 400, 200, 200]} color={colors.primaryText} w={["20.5rem", "20.875rem", "28.5rem", "28.5rem"]}>Connect with people who can help
                    </Heading>
                    <AppButton
                ...
                >
                    ...
                    />
                    <Heading
                        lineHeight="1.25" fontSize={["2rem", "2rem", "3rem", "3rem"]} fontWeight={[400, 400, 200, 200]} color={colors.primaryText} w={["20.5rem", "21.875rem", "28.5rem", "28.5rem"]}>Learn the skills you need to succeed
                    </Heading>
                    {/* <Page>
                        <Select
                            data={topicOptions}
                    ...
                    <Menu w={["5.861rem", "21.875rem", "5.861rem", "5.861rem"]}>
                        <MenuButton fontSize={["1.25rem", "1.25rem", "0.75rem", "0.75rem"]}
                            h={["5.25rem", "3.688rem", "3.688rem", "3.688rem"]}

                            borderRadius="0.2rem" w={["19.5rem", "21.875rem", "15rem", "15rem"]} border={`0.5px solid ${colors.linkText}`} padding={["0", "0.5rem", "0.5rem", "0.5rem"]} fontWeight={600} _active={{ backgroundColor: "transparent" }} _hover={{ backgroundColor: "transparent", color: "#0a66c2", }}
