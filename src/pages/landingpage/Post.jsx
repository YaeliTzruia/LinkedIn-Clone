...
export default function Post() {
    ...
    return (
        <Flex justifyContent="center" alignItems="center" h="15rem" w="100%" backgroundColor="#f0ebe6">
            <Flex paddingX={["1.5rem", "1.5rem", "0", "0"]} flexDir={["column", "column", "row", "row"]} w={["25.875rem", "25.875rem", "70.5rem", "70.5rem"]}>
                <Flex w="30rem" h="6.25rem">
                    <Heading marginRight="4.188rem" color="#b24020" fontWeight={[500, 500, 400, 400]} fontSize={["2rem", "2rem", "3.5rem", "3.5rem"]} as="h2">Post your job for millions of people to see</Heading>
